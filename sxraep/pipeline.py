"""End-to-end workflows for sxRaep training and prediction."""
...
def run_training_pipeline(
    ...
    output_dir: str | Path = "results/raep_training",
    feature_config: FeatureConfig | None = None,
    training_config: TrainingConfig | None = None,
    xgb_params: Mapping[str, Any] | None = None,
) -> dict[str, Any]:
    """Run the complete FASTA-to-model sxRaep training workflow."""
...
def run_prediction_pipeline(
    ...
    """Run the complete FASTA-to-prediction sxRaep workflow."""
