"""Command-line interface for sxRaep."""
...
def build_parser() -> argparse.ArgumentParser:
    """Build the sxRaep command-line argument parser."""

    parser = argparse.ArgumentParser(description="sxRaep enzyme/non-enzyme classifier")
    subparsers = parser.add_subparsers(dest="command", required=True)

    train = subparsers.add_parser("train", help="train an sxRaep classifier")
    ...
    train.add_argument("--outdir", default="results/raep_training", help="output directory")
...
def main(argv: list[str] | None = None) -> None:
    """Run the sxRaep command-line interface."""
