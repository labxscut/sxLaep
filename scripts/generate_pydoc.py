#!/usr/bin/env python3
"""Generate PyDoc HTML and lightweight Markdown documentation for sxRaep."""
...
<head>
  <meta charset="utf-8">
  <title>sxRaep API Documentation</title>
  <style>
...
<body>
  <h1>sxRaep API Documentation</h1>
...
def write_api_reference() -> None:
    ...
    lines = ["# sxRaep API Reference", "", "This file is generated by `scripts/generate_pydoc.py`.", ""]
