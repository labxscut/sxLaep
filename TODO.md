...
- **`pipx`**: **`pipx install`** / **`pipx upgrade`** from **PyPI**; post-install **`sxlaep --help`** and **`sxlaep --input example.fasta`** smoke plus CSV preview (unless **`SXLAEP_SKIP_CLI_SMOKE=1`**).
